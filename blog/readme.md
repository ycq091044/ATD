...
**Accuracy and Complexity Comparison:** The overall comparison with baselines models are given below, ATD shows comparable or better performance over the baselines. Basically, we can conclude that it is useful to consider both fitness and alignment as part of the objective. The table also shows that tensor based models require fewer parameters, i.e., less than 5% of parameters compared to deep learning models.
